...
*/
 TEST_CASE("IntElement", "[isValidInt]") {
    ...
    REQUIRE_THROWS_WITH(IntElement(",3"), "Element contains zero or multiple chars, one char or integer required");
    REQUIRE_THROWS_WITH(IntElement("++3"), "Element contains zero or multiple chars, one char or integer required");
...
*/
 TEST_CASE("VariableElement", "[isValidVar]") {
    // String constructor
	REQUIRE_THROWS_WITH(VariableElement("aa"), "Element contains zero or multiple chars, one char or integer required");
    REQUIRE_THROWS_WITH(VariableElement("abc"), "Element contains zero or multiple chars, one char or integer required");
...
TEST_CASE("ConcreteSquareMatrix String constructor", "[ConcreteSquareMatrixN-1]")
{
	...
	invalids.push_back(TestContainer("a[2]]", "Should start \"[[\", Started \"a[\" instead"));

	invalids.push_back(TestContainer("[[]]", "Too few characters to be a Matrix"));

	invalids.push_back(TestContainer("1[2]]", "Should start \"[[\", Started \"1[\" instead"));
	...
	invalids.push_back(TestContainer("[[1.1,2,0.3e][13,1.4,6.01][5.11,1.5,-.7]]", "Element not an integer, or it contains character"));
