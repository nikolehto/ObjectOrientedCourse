...
TEST_CASE("SquareMatrix little ones", "[SquareMatrix]") {
 ...
 /**
 *  \brief Matrix unit tests for SquareMatrix, focuses to test assignments and constructors - will run in main generated by catch.hpp
 *  \return 0 if tests passes
 */
TEST_CASE("CopyNMoveConstructorsAndAssignments", "[COPYnASSIGN]")
{
    ...
    // Full copy test
    c = SquareMatrix("[[1,2][3,4]]");
    SquareMatrix abcopy_old(c); // clone
    REQUIRE(abcopy_old == c);
    {  // limit scope
        SquareMatrix abcopy_new(abcopy_old); // clone
